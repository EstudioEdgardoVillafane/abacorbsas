...
export const PRODUCTOS : Productos[] = [
    ...
    {id: 3, nombre: 'Membrana-Cementicia', imagen:"/assets/img/membranacement.png" },
    {id: 4, nombre: 'Abaplak-Multifuncion', imagen:"/assets/img/multifunc.png" },
    {id: 5, nombre: 'Revoque-fino-al-Yeso', imagen:"/assets/img/yeso.png" },
